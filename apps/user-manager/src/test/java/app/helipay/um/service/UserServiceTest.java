...
class UserServiceTest {
    ...
    private static final String DEFAULT_USERNAME = "johndoe_service";
    ...
    void assertThatOnlyActivatedUserCanRequestPasswordReset() {
        ...
        Optional<UserEntity> maybeUser = userService.requestPasswordReset(user.getUsername());
        assertThat(maybeUser).isNotPresent();
    ...
    void assertThatResetKeyMustNotBeOlderThan24Hours() {
        ...
        String resetKey = RandomStringUtils.randomAlphanumeric(6);
        user.setActivated(true);
