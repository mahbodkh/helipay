package app.helipay.um.handler;
...
//                = userRepository.findAllByAuthoritiesIn(Set.of(new Authority(AuthoritiesConstants.ADMIN)));
...
//
//
//    public List<UserEntity> getAllUserEntitiesByCity(String city) {
////        return userRepository.findAllByCity(city);
//        return null;
//    }
//
//    public List<UserEntity> getAllUserEntitiesByLanguage(String language) {
////        return userRepository.findAllByLanguage(language);
//        return null;
//    }
//
//    public List<UserEntity> getAllUserEntitiesByDefaultLanguage() {
////        return userRepository.findAllByLanguage(getUser().langKey());
//        return null;
//    }
//
//    public List<UserEntity> getUserIdsNearby(long userId, double radius) {
//        // Implement logic to find user IDs within a certain radius of a given userId
//        // This could involve geolocation data, depending on how it's stored
////        return userRepository.findAllByNearby(userId, radius);
//        return null;
//    }
//
//    // warning
